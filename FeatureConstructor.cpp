...
void FeatureConstructor::extract_vocab(char*** data_list,int* documents_size, int number_documents)
{

}

//Builds feature vectors for all documents in document_feature_vectors from data_list
void FeatureConstructor::construct_feature_vectors(char*** data_list,int* documents_size, int number_documents)
{
